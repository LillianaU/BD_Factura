...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2023 a las 05:40:13
...
INSERT INTO `factura` (`fac_id`, `cli_id`, `mon_id`, `fac_fec`, `fac_sub`, `fac_iva`, `fac_tot`, `fac_tc`) VALUES
...
--
ALTER TABLE `factura`
  ADD CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`cli_id`) REFERENCES `clientes` (`cli_id`),
  ADD CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`mon_id`) REFERENCES `monedas` (`mon_id`);

--
-- Filtros para la tabla `facturas_detalle`
--
ALTER TABLE `facturas_detalle`
  ADD CONSTRAINT `facturas_detalle_ibfk_1` FOREIGN KEY (`fac_id`) REFERENCES `factura` (`fac_id`);
COMMIT;
